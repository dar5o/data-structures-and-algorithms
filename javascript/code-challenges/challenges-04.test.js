...
const sortNames = (arr) => {
  // Solution code here...
  let nameArr = arr.sort((firstName, secondName) => {
...
const sortNumbers = (arr) => {
  // Solution code here...
  let numArr = arr.sort((firstNumber, secondNumber) => {
...
const sortBackwards = (arr) => {
  // Solution code here...
  let bacArr = arr.sort((firstNumber, secondNumber) => {
...
const alphabetize = (arr) => {
  // Solution code here...
  let alphaArr = arr.sort((firstString, secondString) => {
...
const sortByPrice = (arr) => {
  // Solution code here...
  let priArray = arr.sort((firstProduct, secondProduct) => {
