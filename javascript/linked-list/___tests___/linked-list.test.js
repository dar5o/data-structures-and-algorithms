...
describe('Given linked list', () => {
  ...
  describe('When inserting', () => {
    it('should prepend to the front of the linked list', () => {
      // Create Linked List
      let list = new LinkedList();
      // Create Test Values
  ...
  describe('When checking if value is included', () => {
    ...
    it('should return true if value is present in linked list', () => {
      expect(list.includes('Test 03')).toBeTruthy();
    });

    it('should return false if value is not present in the linked list', () => {
